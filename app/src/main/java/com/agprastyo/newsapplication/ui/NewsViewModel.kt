...
import com.agprastyo.newsapplication.NewsApplication
...
class NewsViewModel(
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String) {
        ...
        try {
            ...
            when(t) {
                is IOException -> breakingNews.postValue(Resource.Error("Netwwork Failure"))
    ...
    private suspend fun safeSearchNewsCall(searchQuery: String) {
        ...
        try {
            ...
            when(t) {
                is IOException -> searchNews.postValue(Resource.Error("Netwwork Failure"))
